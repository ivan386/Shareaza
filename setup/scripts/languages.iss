...
; Norwegian
Source: "setup\license\norwegian.rtf"; DestDir: "{app}\Uninstall"; DestName: "license.rtf"; Flags: ignoreversion overwritereadonly uninsremovereadonly sortfilesbyextension; Languages: no; Tasks: language
; Afrikaans
...
pt_br.tasks_allusers=Todos os Usuarios
pt_br.tasks_selectusers=Instalar %1 para:
pt_br.tasks_currentuser=%1 apenas
pt_br.tasks_multisetup=Ativar suporte para varios usuarios
pt_br.tasks_firewall=Adicionar excecao ao Firewall do Windows
...
pt_br.icons_license=Licenca
pt_br.icons_uninstall=Desinstalar
pt_br.icons_downloads=Downloads
pt_br.icons_basicmode=Modo Simples
pt_br.icons_tabbedmode=Modo Avancado
pt_br.icons_windowedmode=Modo de Janelas
pt_br.dialog_shutdown=Você quer fechar o %1?
pt_br.dialog_firewall=A instalacao falhou ao tentar adicionar o Shareaza à lista de excecoes do Firewall do Windows.%nPor favor adicione manualmente o Shareaza a lista.
pt_br.dialog_malwaredetected=Um malware foi detectado no seu sistema as %1, por favor remova-o com um scanner contra virus/malware antes de instalar o Shareaza. Voce quer sair agora?
pt_br.page_viruswarning_text=Ao usar a Internet voce deve sempre manter seu Anti-Virus atualizado, para proteger contra virus, worms, cavalos-de-troia e outros programas perigosos. Voce encontra uma lista de bons anti-virus e dicas de seguranca entrando no seguinte endereco:
pt_br.page_viruswarning_title=Aviso sobre_Virus
pt_br.page_viruswarning_subtitle=Voce tem um programa anti-virus instalado?
pt_br.CreateDesktopIcon=Mostrar um icone na &area de trabalho
pt_br.CreateQuickLaunchIcon=Mostrar um icone na barra de &Inicializacao Rapida
; French
