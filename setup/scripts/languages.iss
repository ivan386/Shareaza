...
; Spanish
Source: "Remote-localized\spanish\*"; DestDir: "{app}\Remote"; Flags: ignoreversion overwritereadonly uninsremovereadonly sortfilesbyextension; Languages: es; Components: language
; Russian
...
; Swedish
Source: "Remote-localized\swedish\*"; DestDir: "{app}\Remote"; Flags: ignoreversion overwritereadonly uninsremovereadonly sortfilesbyextension; Languages: sv; Components: language
...
lt.tasks_firewall=Add an exception to the Windows Firewall
...
de.tasks_firewall=Add an exception to the Windows Firewall
...
pt.tasks_firewall=Add an exception to the Windows Firewall
...
no.tasks_firewall=Add an exception to the Windows Firewall
...
af.tasks_firewall=Add an exception to the Windows Firewall
...
br.tasks_firewall=Add an exception to the Windows Firewall
...
fr.tasks_firewall=Add an exception to the Windows Firewall
...
es.tasks_firewall=Add an exception to the Windows Firewall
...
ru.tasks_firewall=Add an exception to the Windows Firewall
...
gr.tasks_firewall=Add an exception to the Windows Firewall
...
hu.tasks_firewall=Add an exception to the Windows Firewall
...
chs.tasks_firewall=Add an exception to the Windows Firewall
chs.run_skinexe=°²×°Æ¤·ô...
...
sv.tasks_firewall=Add an exception to the Windows Firewall
