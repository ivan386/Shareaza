...
tasks_languages=Multi-idioma
tasks_allusers=Todos os Usuários
tasks_selectusers=Instalar o %1 para:
tasks_currentuser=só para o %1
tasks_multisetup=Ativar suporte para vários usuários
tasks_firewall=Adicionar uma exceção ao Firewall do Windows
tasks_upnp=Ativar o descobrimento de dispositivos UPnP
tasks_deleteoldsetup=Apagar os instaladores antigos
tasks_resetdiscoveryhostcache=Resetar o Descobrimento e o Cache dos Hosts
run_skinexe=Executando a instalação das skins...
reg_incomingchat=Mensagem de chat a entrar
reg_apptitle=Shareaza o Último Compartilhador de Arquivo
icons_license=Licença
icons_uninstall=Desinstalar
icons_downloads=Downloads
icons_basicmode=Modo Simples
icons_tabbedmode=Modo em Abas
icons_windowedmode=Modo de Janelas
dialog_shutdown=O %1 está rodando atualmente. Você gostaria que o %1 fosse fechado para que a instalação possa continuar?
dialog_firewall=A instalação falhou ao tentar adicionar o Shareaza a lista de exceções do Firewall do Windows.%nPor favor adicione o Shareaza a lista de exceções manualmente.
dialog_malwaredetected=Um malware foi detectado no seu sistema em %1, por favor remova-o com um scanner contra vírus/malware antes de instalar o Shareaza. Você quer sair agora?
page_viruswarning_text=Quando usar a Internet você deve sempre garantir que você tenha um scanner contra vírus atualizado para proteger você de trojans, worms e outros programas maliciosos. Você pode achar uma lista de bons scanners contra vírus e outras dicas de segurança para proteger seu computador seguindo este link:
page_viruswarning_title=Aviso sobre_Vírus
