...
tasks_multisetup=Omoguæi više-korisnièku podršku
...
reg_incomingchat=Dolazeæe cet poruke
...
dialog_shutdown=%1 je ukljuèena. Da li bi želeli da %1 bude ugašena da bi se instalacija nastavila?
dialog_firewall=Instalacija nije uspla da doda Shareaza-u u Windows Vatrozid.%nMolimo dodajte Shareaza-u na listu izuzetaka ruèno.
...
page_viruswarning_text=Kada koristite internet, trebali bi uvek da budete sigurni da imate ažuriaran virus skener koji Vas štiti od trojanaca, crva, i drugih zlonamernih programa. Možete pronaæi listu dobrih anti-virus programa i drugih sigurnosnih saveta kako da zaštitite Vaš raèunar prateæi ovaj link:
