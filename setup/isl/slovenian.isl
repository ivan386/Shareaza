...
components_plugins=Vtièniki
components_skins=Preobleke
tasks_languages=Jeziki
tasks_allusers=Vsi uporabniki
tasks_selectusers=Namesti %1 za:
tasks_currentuser=Samo %1
tasks_multisetup=Omogoèi veè-uporabniško podporo
tasks_firewall=Dodaj izjemo v Windows požarni zid
tasks_upnp=Enable discovery of UPnP devices
tasks_deleteoldsetup=Briši stare namešèevalce
tasks_resetdiscoveryhostcache=Reset Discovery and Hostcache
run_skinexe=Namestitev preobleke v teku...
reg_incomingchat=Vhodno kramljalno sporoèilo
reg_apptitle=Izjemno Shareaza deljenje datotek
icons_license=Licenca
icons_uninstall=Odnamestitev
icons_downloads=Prenosi
icons_basicmode=Navadni naèin
icons_tabbedmode=Naèin z zavihki
icons_windowedmode=Naèin z okni
dialog_shutdown=%1 je trenutno v teku. Ali želite zapreti %1 zato, da se lahko nadaljuje namestitev?
dialog_firewall=Program namestitve ni uspel dodati Shareaze v požarni zid Windows-ov.%nShareazo boste morali roèno dodati v seznam izjem v požarnem zidu.
...
page_viruswarning_text=Pri uporabi medmrežja imejte namešèeno vedno najnovejšo razlièico protivirusne zašèite. Tako boste kar najbolje zašèiteni pred trojanskimi konji, èrvi in drugimi zlonamernimi programji. Seznam dobrih protivirusnih programov, ter drugih nasvetov glede zašèite vašega raèunalnika, boste našli preko naslednje spletne povezave:
page_viruswarning_title=Virusno opozorilo
page_viruswarning_subtitle=Ali imate namešèen protivirusni program?
