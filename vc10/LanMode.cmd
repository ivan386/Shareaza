...
setlocal
cd ..
set BUILDDIR=vc10\Win32\Release\
...
echo msbuild vc10\Shareaza.sln /nologo /v:m /t:Rebuild /p:ForceImportBeforeCppTargets="%CD%\vc10\LanMode.props" /p:Configuration=Release /p:Platform=Win32 /fl /flp:Summary;Verbosity=normal;LogFile=%BUILDDIR%Shareaza_r$WCREV$_$WCNOW=%%Y-%%m-%%d$.log >> %BUILDDIR%LanMode.tmp
